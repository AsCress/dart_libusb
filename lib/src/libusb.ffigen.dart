...
import 'package:dart_libusb/src/libusb_base.dart' as pkg_libusb;
...
class Libusb {
  ...
  ffi.Pointer<ffi.Char> libusb_strerror(libusb_error errcode) {
    return _libusb_strerror(errcode.value);
  }
  ...
  int libusb_set_option(ffi.Pointer<libusb_context> ctx, libusb_option option) {
    return _libusb_set_option(ctx, option.value);
  }

  late final _libusb_set_optionPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<libusb_context>, ffi.UnsignedInt)
        >
      >('libusb_set_option');
